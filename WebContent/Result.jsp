					...
					<!-- Contact -->	
					 <article id="login_main">
                        ...
                        %>
					     ...
					     <input type="button" value="카페 선택" style="margin-bottom: 1rem;" onclick="location.href='RecommendCafe.jsp#cafe'">
                        <h2 class="major" style="margin-left: 32.8%; magin-right: auto; magin-botton:3%;">차차 추천 코스</h2>
                                 ...
                                 <div  style="margin: 0 auto;">
                                      ...
                                      <div style="margin: 0 auto;">
                                 		<div style="display:grid; grid-template-columns : 30% 1fr;">
                                 			<div><%if(selected_cafe.equals("카페가 없습니다")){}else{ %><img src="images/cafe_pic/<%= selected_cafe %>.JPG" style="width: 100%; height: 100%"><% }%></div>
                                 			<div style="padding-top: 2%; padding-left: 5%; font-size: 80%;">
                                 				<%
		                                 			if(selected_cafe.equals("카페가 없습니다")){%>
		                                        		카페가 없습니다
		                                        	<% }else{%>
                                 						주소 : <%=cafe_voArr.get(cafe_id).getAddress() %><br>
                                 						운영시간(평일): <%=cafe_voArr.get(cafe_id).getWeekday_time() %><br>
                                 						운영시간(토요):<%=cafe_voArr.get(cafe_id).getSaturday_time() %><br>
                                 						운영시간(일요):<%=cafe_voArr.get(cafe_id).getSunday_time() %><br>
                                 						휴무일 : <%=cafe_voArr.get(cafe_id).getHollyday() %><br>
                                 						주차 :<%=cafe_voArr.get(cafe_id).getParking() %><br>
                                 				<%} %>
                                 			</div>
                                 		</div>
                                	 </div>      
                        ...
                        <div style="text-align: right;">
                        	<input type="button" value="처음으로"  style="margin-bottom: 1rem;" onclick="location.href='main.jsp'">	
                        </div>
